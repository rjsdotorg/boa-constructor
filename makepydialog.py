...
class MakePyDialog(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.typeLibraryList.SetToolTip('List of the registered COM type libraries on your system')
        ...
        self.OK = wx.Button(id=wxID_MAKEPYDIALOGOK, label='Generate', name='OK',
              ...
              style=0)
        self.OK.SetToolTip('Click to generate a wrapper for the selected library')
        ...
        self.Cancel = wx.Button(id=wx.ID_CANCEL, label='Cancel', name='Cancel',
              ...
              style=0)
        self.Cancel.SetToolTip('Cancel wrapper generation')
        ...
        self.bForDemand = wx.CheckBox(id=wxID_MAKEPYDIALOGBFORDEMAND,
              ...
              style=0)
        self.bForDemand.SetToolTip('Minimises amount of code generated by only wrapping used classes (recommended).  Clear to generate a single-file wrapper.')
        ...
        self.directSpecification.SetToolTip('Type text here to search for matching type libraries')
