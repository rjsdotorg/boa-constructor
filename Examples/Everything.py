...
[wxID_FRAME1, wxID_FRAME1BITMAPBUTTON1, wxID_FRAME1BUTTON1,
 ...
 ] = [wx.NewIdRef(count=1) for _init_ctrls in range(56)]

[wxID_FRAME1TOOLBAR1TOOLS0] = [wx.NewIdRef(count=1) for _init_coll_toolBar1_Tools in range(1)]

[wxID_FRAME1MENU1ITEMS0] = [wx.NewIdRef(count=1) for _init_coll_menu1_Items in range(1)]

[wxID_FRAME1TIMER1] = [wx.NewIdRef(count=1) for _init_utils in range(1)]
...
class Frame1(wx.Frame):
    ...
    def _init_coll_menu1_Items(self, parent):
        ...
        parent.Append(helpString='', id=wxID_FRAME1MENU1ITEMS0, item='Items0')
    ...
    def _init_coll_toolBar1_Tools(self, parent):
        ...
        # parent.AddTool(bitmap=wx.BitmapBundle.FromBitmap(Everything_img.getBoaBitmap()),
        #                toolid=wxID_FRAME1TOOLBAR1TOOLS0, isToggle=False, longHelpString='',
        #                pushedBitmap=wx.NullBitmap, shortHelpString='Tools0')

        parent.AddTool(toolId=wxID_FRAME1TOOLBAR1TOOLS0,
                                                bitmap=wx.BitmapBundle.FromBitmap(Everything_img.getBoaBitmap()),
                                                label='test',
                                                shortHelp='Tools0',
                                                kind=wx.ITEM_NORMAL)
    ...
    def _init_utils(self):
        ...
        self.stockCursor1 = wx.Cursor(wx.CURSOR_PENCIL)
    ...
    def _init_ctrls(self, prnt):
        ...
        self.splitterWindow1 = wx.SplitterWindow(id=wxID_FRAME1SPLITTERWINDOW1,
                                                 name='splitterWindow1', parent=self.panel1, pos=wx.Point(8, 8),
        ...
        self.sashWindow1 = wx.adv.SashWindow(id=wxID_FRAME1SASHWINDOW1,
                                         name='sashWindow1', parent=self.splitterWindow1, pos=wx.Point(107,
                                                                                                       2),
                                         size=wx.Size(91, 96), style=wx.CLIP_CHILDREN | wx.adv.SW_3D)
        ...
        self.sashLayoutWindow1 = wx.adv.SashLayoutWindow(id=wxID_FRAME1SASHLAYOUTWINDOW1,
                                                     name='sashLayoutWindow1', parent=self.panel1, pos=wx.Point(8,
                                                                                                                120),
                                                     size=wx.Size(200, 80), style=wx.CLIP_CHILDREN | wx.adv.SW_3D)
        ...
        self.dynamicSashWindow1 = wx.gizmos.DynamicSashWindow(id=wxID_FRAME1DYNAMICSASHWINDOW1,
                                                              name='dynamicSashWindow1', parent=self.panel1,
                                                              pos=wx.Point(216,
                                                                           8), size=wx.Size(100, 100),
        ...
        self.slider1 = wx.Slider(id=wxID_FRAME1SLIDER1, maxValue=100,
                                 ...
                                 pos=wx.Point(152, 16), size=wx.Size(136, 20),
        ...
        self.genBitmapButton1 = wx.lib.buttons.GenBitmapButton(id=wxID_FRAME1GENBITMAPBUTTON1,
                                                               ...
                                                               parent=self.panel3, pos=wx.Point(16, 192),
                                                               size=wx.Size(59, 58),
                                                               style=0)
        ...
        self.genToggleButton1 = wx.lib.buttons.GenToggleButton(id=wxID_FRAME1GENTOGGLEBUTTON1,
                                                               ...
                                                               parent=self.panel3, pos=wx.Point(104, 160),
                                                               size=wx.Size(113, 37),
                                                               style=0)
        ...
        self.genBitmapToggleButton1 = wx.lib.buttons.GenBitmapToggleButton(id=wxID_FRAME1GENBITMAPTOGGLEBUTTON1,
                                                                           ...
                                                                           parent=self.panel3,
                                                                           pos=wx.Point(72, 192), size=wx.Size(59, 58),
                                                                           style=0)
        ...
        self.radioBox1 = wx.RadioBox(choices=['asd'], id=wxID_FRAME1RADIOBOX1,
                                     ...
                                     parent=self.panel4, pos=wx.Point(16, 16), size=wx.DefaultSize,
        ...
        self.editableListBox1 = wx.adv.EditableListBox(id=wxID_FRAME1EDITABLELISTBOX1,
